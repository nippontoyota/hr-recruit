...
class LocationTemplate(Base):
    ...
    __table_args__ = (
        UniqueConstraint("brand", "branch_location", "name", name="uq_location_templates_brand_branch_name"),
    )
...
class TouchpointTemplate(Base):
    ...
    __table_args__ = (
        UniqueConstraint("brand", "branch_location", "name", name="uq_touchpoint_templates_brand_branch_name"),
    )
...
class InterviewerName(Base):
    ...
    __table_args__ = (
        UniqueConstraint("brand", "branch_location", "name", name="uq_interviewer_names_brand_branch_name"),
    )
