      ...
      <AnimatePresence>
        {isOpen && (
          <DialogPrimitive.Portal forceMount>
            {/* Backdrop with edge blur effect */}
            ...
            <DialogPrimitive.Content asChild forceMount>
              <motion.div
                ...
                className={cn(
                  ...
                  "bg-surface border border-border shadow-2xl sm:rounded-2xl overflow-hidden"
                )}
              >
                {/* Header */}
                <div className="flex items-center justify-between border-b border-border px-6 py-4 bg-surface z-10">
                  <div>
                    {title && (
                  ...
                  <DialogPrimitive.Close asChild>
                    <Button variant="ghost" size="sm" className="p-2 -mr-2 text-text-secondary hover:text-text-primary">
                      <X className="h-5 w-5" />
