  ...
  return (
    <div className="p-6 w-full space-y-8 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Link to="/demo-admin/pipeline" className="group bg-gradient-to-br from-orange-600 via-orange-400 to-orange-700 bg-[length:200%_200%] bg-left hover:bg-right transition-all duration-700 ease-out rounded-xl p-6 shadow-lg shadow-orange-900/20 border border-white/20 text-white relative overflow-hidden block cursor-pointer">
        ...
        <Link to="/demo-admin/bottlenecks" className="group bg-gradient-to-br from-rose-600 via-rose-400 to-rose-700 bg-[length:200%_200%] bg-left hover:bg-right transition-all duration-700 ease-out rounded-xl p-6 shadow-lg shadow-rose-900/20 border border-white/20 text-white relative overflow-hidden block cursor-pointer">
          <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent pointer-events-none"></div>
          <div className="absolute top-0 right-0 -mr-4 -mt-4 opacity-20 group-hover:opacity-30 transition-opacity">
        ...
        <Link to="/demo-admin/outcomes" className="group bg-gradient-to-br from-emerald-600 via-emerald-400 to-emerald-700 bg-[length:200%_200%] bg-left hover:bg-right transition-all duration-700 ease-out rounded-xl p-6 shadow-lg shadow-emerald-900/20 border border-white/20 text-white relative overflow-hidden block cursor-pointer">
          <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent pointer-events-none"></div>
          <div className="absolute top-0 right-0 -mr-4 -mt-4 opacity-20 group-hover:opacity-30 transition-opacity">
        ...
        <Link to="/demo-admin/users" className="group bg-gradient-to-br from-blue-600 via-blue-400 to-blue-800 bg-[length:200%_200%] bg-left hover:bg-right transition-all duration-700 ease-out rounded-xl p-6 shadow-lg shadow-blue-900/20 border border-white/20 text-white relative overflow-hidden flex flex-col h-full justify-between cursor-pointer">
          <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent pointer-events-none"></div>
          <div className="absolute top-0 right-0 -mr-4 -mt-4 opacity-20 group-hover:opacity-30 transition-opacity">
            <Shield size={120} />
          </div>
