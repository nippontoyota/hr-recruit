...
import { mockBottlenecksData } from './mockData';
...
export default function AdminBottlenecksList() {
  ...
  const fetchBottlenecks = async () => {
    setLoading(true);
    setTimeout(() => {
      let filtered = mockBottlenecksData.data;
      if (filterMode !== 'ALL') {
        filtered = filtered.filter((c: any) => filterMode === 'INTERVIEWS' ? c.current_stage === 'PENDING_INTERVIEW' : c.current_stage === 'ON_HOLD');
      }
      if (searchQuery) {
